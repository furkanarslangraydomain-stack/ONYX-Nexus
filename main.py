...
try:
    from vector_db import ContextCompactor, LightweightVectorDB, SQLiteAgentMemory
except Exception:
...
try:
    ...
    def optional_memory_backend(): return None
    def optional_vector_backend(): return None
